...
const router = Router();
router.options('*', cors());
router.get("/drinks",cors(), async (req: Request, res: Response) => {
  try {
...
router.post("/drinks", cors(), async (req: Request, res: Response) => {
  try {
...
router.get("/drinks/:drinkId", cors(), async (req: Request, res: Response) => {
  try {
...
router.put("/drinks/:drinkId", cors(), async (req: Request, res: Response) => {
  try {
    const drinkId = req.params["drinkId"];
    const drink = await Drink.findByPk(drinkId);
...
router.delete("/drinks/:drinkId", cors(), async (req: Request, res: Response) => {
  try {
    const drinkId = req.params["drinkId"];
    await Drink.destroy({
      where: {
...
router.get("/drinks/:drinkId/reviews", cors(), async (req: Request, res: Response) => {
  try {
    const offset = Number(req.query["offset"]);
    const length = Number(req.query["length"]);
...
router.post("/drinks/:drinkId/reviews", cors(), async (req: Request, res: Response) => {
  try {
    const drinkId = req.params["drinkId"];
    const drink = await Drink.findByPk(drinkId);
...
router.get("/drinks/:drinkId/pictures", cors(), async (req: Request, res: Response) => {
  try {
    const drinkId = req.params["drinkId"];
